...
const MyAccountScreen = () => {
  ...
  const handleLogout = async () => {
    ...
    await AsyncStorage.removeItem("idAccount"); // Xóa token khỏi AsyncStorage
    setIsLoggedIn(false);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View
          style={{ backgroundColor: "#77fc89", width: "100%", height: "100%" }}
        ></View>
      </View>
      <View
        style={{
