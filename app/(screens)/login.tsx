        ...
        <View>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={{ marginTop: 20 }}>
              ...
              <TouchableOpacity>
                <View style={{
                  flexDirection: 'row', justifyContent: 'center', alignItems: 'center', backgroundColor: 'green', height: 55,
                  borderRadius: 8
                }}>
                  <Feather name="chevrons-right" size={24} color="white" />
                  <Text style={{ paddingLeft: 10, color: 'white', fontWeight: 500, fontSize: 18 }} onPress={handleLogin}>
                    LOGIN
                  </Text>
                </View>
              </TouchableOpacity>
